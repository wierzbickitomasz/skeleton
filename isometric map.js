   ...
   const directions = {
   northWest: { offset: 11, x: -2, y: -1, opposite: 'southEast' }, //lg
   southEast: { offset: 0, x: 2, y: 1, opposite: 'northWest' },//pd
   northEast: { offset: 35, x: 2, y: -1, opposite: 'southWest' }, //pg
   southWest: { offset: 24, x: -2, y: 1, opposite: 'northEast' } //ld

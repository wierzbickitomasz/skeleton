...
class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        skeletons.push(this.add.existing(new Skeleton(this, 240, 290, 'walk', 'southEast', 100))); //ost arg to dystans
        skeletons.push(this.add.existing(new Skeleton(this, 330, 390, 'walk', 'northEast', 100))); //ost arg to dystans
